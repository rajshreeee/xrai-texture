"""
Kernel Drift Analysis — CBIS, ResNet18UNet, data-size ablation (kr variant)
Produces:
...
BASELINE_CKPT_DIR = CKPT_DIR  # both conditions live in the same directory
...
CHECKPOINTS = {
    "Baseline": {"inject_blocks": None,       "ckpt_prefix": "A_baseline",   "ckpt_dir": BASELINE_CKPT_DIR},
    "B_layer1": {"inject_blocks": ["layer1"], "ckpt_prefix": "KR_B_layer1",  "ckpt_dir": CKPT_DIR},
}
...
def collect_all():
    print("\n" + "=" * 60)
    print("  Collecting drift — CBIS, ResNet18UNet, data-size (kr)")
    print("=" * 60)
    data = {}
