"""
Kernel Drift Analysis — CBIS-DDSM, ResNet18UNet, data-size ablation
Produces:
...
LAYERS_TO_ANALYZE = [
    ("layer1", 0, "conv1", "layer1_0_conv1"),  # injected for B_layer1; shape (64,  64, 3, 3)
    ("layer1", 0, "conv2", "layer1_0_conv2"),  # 2nd conv in same BasicBlock; shape (64, 64, 3, 3)
    ("layer2", 0, "conv1", "layer2_0_conv1"),  # uninjected control; shape (128, 64, 3, 3)
]
...
def collect_all():
    print("\n" + "=" * 60)
    print("  Collecting drift — CBIS-DDSM, ResNet18UNet, data-size")
    print("=" * 60)
    data = {}
