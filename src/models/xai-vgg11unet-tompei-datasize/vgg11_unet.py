...
class VGGBlock(nn.Module):
    """Conv block with 1, 2, or 3 Conv-BN-ReLU units.
...
class VGG11UNet(nn.Module):
    """VGG11-style encoder + U-Net decoder for binary segmentation.

    Encoder follows VGG11 channel progression (64, 128, 256, 512, 512) with
    1-conv blocks for stages 1-2 and 2-conv blocks for stages 3-5, matching
    the original VGG11 architecture.
    ...
    def __init__(self, in_channels=3, out_channels=1):
        ...
        # Encoder — VGG11-style
        self.enc1 = VGGBlock(in_channels, 64,  n_convs=1)   # injection site
        self.enc2 = VGGBlock(64,          128, n_convs=1)
        self.enc3 = VGGBlock(128,         256, n_convs=2)
        self.enc4 = VGGBlock(256,         512, n_convs=2)
        self.enc5 = VGGBlock(512,         512, n_convs=2)
