...
def parse_args():
    ...
    p.add_argument("--checkpoint",   required=False,  help="Full path to .pt file", default="/ediss_data/ediss2/xai-texture/src/models/xai-model-run4-kr/checkpoints/D_layer1_init_seed42_best.pt")
    p.add_argument("--domain",       required=False,  default="kernel ranking")
