...
LOG_DIR = Path("/ediss_data/ediss2/xai-texture/src/models/xai-resnet18unet-tompei-datasize/logs")
...
for fraction in FRACTIONS:
    ...
    layer1 = results.get(fraction, {}).get("B_layer1", {})
    ...
    rows.append({
        ...
        "Layer1 Test Dice": layer1_best,
        "Baseline Test IoU": base.get("iou"),
        "Layer1 Test IoU": layer1.get("iou"),

        "Target Dice (min best)": target,
        "Baseline Epoch @ Target": base_epoch_to_target,
        "Layer1 Epoch @ Target": layer1_epoch_to_target,
    })
