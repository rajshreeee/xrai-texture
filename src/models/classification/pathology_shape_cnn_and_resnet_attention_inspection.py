...
def main():
    ...
    print("\n[INFO] Evaluating saved model on training set...")
    load_model_and_evaluate(
        model_path="dual_branch_attention_best_model.pth",
        model_class=lambda: DualBranchCNN(num_classes=2),
        device=device,
        loader=train_loader,
        name="Train"
    )

    print("\n[INFO] Evaluating saved model on test set...")
    load_model_and_evaluate(
        model_path="dual_branch_attention_best_model.pth",
        model_class=lambda: DualBranchCNN(num_classes=2),
        device=device,
