...
os.makedirs("tuned-stacked-ensemble-plots-all-one-swin", exist_ok=True)
...
plt.tight_layout()
plt.savefig("tuned-stacked-ensemble-plots-all-one-swin/training_curves.png")
plt.close()

print("[INFO] Training plots saved to final-stacked-ensemble-plots")

torch.save(model.state_dict(), "tuned-stacked-ensemble-plots-all-one-swin_stacked_ensemble_model.pth")
