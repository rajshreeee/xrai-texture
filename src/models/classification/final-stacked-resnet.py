...
os.makedirs("final-stacked-ensemble-plots", exist_ok=True)
...
torch.save(model.state_dict(), "saads_stacked_ensemble_model.pth")
print("[INFO] Model saved as stacked_ensemble_model.pth")
