"""
Kernel Drift Analysis — TOMPEI, VGG16UNet, data-size ablation (kr variant)
Produces:
...
# VGGBlock layout: conv[0]=Conv2d, conv[1]=BN, conv[2]=ReLU, conv[3]=Conv2d, ...
...
# ── Metrics (identical to vanilla kernel_drift_datasize.py) ───────────────────
...
def collect_all():
    print("\n" + "=" * 60)
    print("  Collecting drift — TOMPEI, VGG16UNet, data-size (kr variant)")
    print("=" * 60)
    data = {}
