...
CHECKPOINTS = {
    ...
    "Fourier":  Path("/ediss_data/ediss2/xai-texture/src/models/xai-model-run3-ft/checkpoints/D_layer1_init_seed42_best.pt"),
    "Kernel Ranking": Path("/ediss_data/ediss2/xai-texture/src/models/xai-model-run4-kr/checkpoints/D_layer1_init_seed42_best.pt"),
}
...
TRAINED_INJECT_LAYER = {
    "Baseline":       None,
    "Fourier":        "layer1",   # B_layer1 → injected into layer1
    "Kernel Ranking": "layer1",   # B_layer1 → injected into layer1
}
