...
OUTPUT_DIR = Path("output_tompei/injection_analysis")
...
DOMAIN_FOLDERS = {
    "xai-tompei-run-baseline/logs": "Baseline",
    "xai-tompei-run1-ft/logs":      "Fourier",
    "xai-tompei-run2-kr/logs":      "Kernel Ranking",
}
