...
OUTPUT_DIR = Path("output/kernel_drift_cbis")
...
CHECKPOINTS = {
    ...
    "Fourier-L2": {
        "inject_layer": "layer2",
        "seeds": {
            42:  RUN3 / "B_layer2_init_seed42_best.pt",      # update if path differs
            123: RUN3 / "B_layer2_init_seed123_best.pt",
            256: RUN3 / "B_layer2_init_seed256_best.pt",
        },
    },
    "KR-L1": {
        "inject_layer": "layer1",
    ...
    "KR-L2": {
        "inject_layer": "layer2",
        "seeds": {
            42:  RUN4 / "B_layer2_init_seed42_best.pt",      # update if path differs
